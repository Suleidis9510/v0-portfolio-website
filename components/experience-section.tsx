...
const experiences = [
  {
    ...
    responsibilities: [
      ...
      "Maintain and update automated test cases using Playwright and TypeScript",
      "Support recurring automated test execution, including smoke and regression coverage",
      "Use Cursor, MCP tools, and AI-assisted workflows to improve QA analysis, bug reporting, documentation, and repetitive testing activities",
      "Identify manual flows that can be automated to improve efficiency and coverage",
